...
DATASETS = [
    ...
    {"name": "glass",         "outlier_col": "class", "outlier_val": "anomaly"},
    {"name": "horse",         "outlier_col": "class", "outlier_val": "anomaly"},
    {"name": "iris",          "outlier_col": "class", "outlier_val": "anomaly"},
    {"name": "mushroom",      "outlier_col": "class", "outlier_val": "anomaly"},
...
ALGORITHMS = [
    ...
    },
    {
        ...
        "uses_gpu": True,
        "init_kwargs": {"k_neighbors": 10, "hidden1": 128, "hidden2": 64,
                        "epochs": 200, "lr": 0.01},
    },
    {
        "name": "GCN-LOF",
        ...
        "uses_gpu": True,
        "init_kwargs": {"k_neighbors": 20, "lof_neighbors": 30,
    ...
    },
    {
        ...
        "uses_gpu": False,
        "init_kwargs": {"K": 3, "lambda_ratio": 0.03},
    },
]
